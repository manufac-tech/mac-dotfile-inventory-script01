...
import pandas as pd
import numpy as np
from dbase.dbase4_merge_sup import (
    process_dupe_names, 
...
def merge_dataframes(dot_items_df, template_df):
    ...
    # Apply duplicate processing functions
    merged_df['item_name'] = merged_df.apply(process_dupe_names, axis=1)
    merged_df['is_folder'] = merged_df.apply(process_dupe_folders, axis=1)

    # Further processing (like handling blanks) will follow
